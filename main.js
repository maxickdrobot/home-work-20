...
document.write("<p>userObj = { <br />");
for (let prop in userObj) {
    document.write(`&nbsp&nbsp&nbsp&nbsp${prop}: ${userObj[prop]} <br />`);
}
document.write("} </p>");
...
document.write(`Full name: ${userObj.fullName()}`)
...
document.write(`<p>defUpperStr("My text"): ${defUpperStr("My text")}</p>`);
document.write(`<p>defUpperStr(): ${defUpperStr()}</p>`);
...
document.write(`<p>evenFn(10): [${evenFn(10)}]</p>`);
document.write(`<p>evenFn(15): [${evenFn(15)}]</p>`);
document.write(`<p>evenFn(20): [${evenFn(20)}]</p>`);
...
document.write(`<p>weekFn(1): ${weekFn(1)}</p>`);
document.write(`<p>weekFn(3): ${weekFn(3)}</p>`);
document.write(`<p>weekFn(7): ${weekFn(7)}</p>`);
document.write(`<p>weekFn(9): ${weekFn(9)}</p>`);
document.write(`<p>weekFn(1.5): ${weekFn(1.5)}</p>`);
document.write(`<p>weekFn('2'): ${weekFn('2')}</p>`);
...
document.write(`<p>    -1 : ${ageClassification(-1)}</p>`);
document.write(`<p>     0 : ${ageClassification(0)}</p>`);
document.write(`<p>     1 : ${ageClassification(1)}</p>`);
document.write(`<p>    24 : ${ageClassification(24)}</p>`);
document.write(`<p> 24.01 : ${ageClassification(24.01)}</p>`);
document.write(`<p>    44 : ${ageClassification(44)}</p>`);
document.write(`<p> 44.01 : ${ageClassification(44.01)}</p>`);
document.write(`<p>    65 : ${ageClassification(65)}</p>`);
document.write(`<p>  65.1 : ${ageClassification(65.1)}</p>`);
document.write(`<p>    75 : ${ageClassification(75)}</p>`);
document.write(`<p> 75.01 : ${ageClassification(75.01)}</p>`);
document.write(`<p>    90 : ${ageClassification(90)}</p>`);
document.write(`<p> 90.01 : ${ageClassification(90.01)}</p>`);
document.write(`<p>   122 : ${ageClassification(122)}</p>`);
document.write(`<p>122.01 : ${ageClassification(122.01)}</p>`);
document.write(`<p>   150 : ${ageClassification(150)}</p>`);
...
document.write(`<p>oddFn(10): [${oddFn(10)}]</p>`);
document.write(`<p>oddFn(15): [${oddFn(15)}]</p>`);
document.write(`<p>oddFn(20): [${oddFn(20)}]</p>`);
...
document.write(`<p>mainFunc(2, 5, cbRandom): ${mainFunc(2, 5, cbRandom)}</p>`);
document.write(`<p>mainFunc(2, 5, cbPow)): ${mainFunc(2, 5, cbPow)}</p>`);
document.write(`<p>mainFunc(2, 5, cbAdd): ${mainFunc(2, 5, cbAdd)}</p>`);
document.write(`<p>mainFunc(2, 5, 'not a func'): ${mainFunc(2, 5, 'not a func')}</p>`);